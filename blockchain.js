...
//22.01.04
const BLOCK_GENERATION_INTERVAL = 10; // in blocks 블록이 생성되는 간격
const DIFFICULTY_ADJUSTMENT_INTERVAL = 10; // 단위는 초 난이도가 조정되는 간격
...
module.exports = {
    ...
    addBlock,
    isValidTimestamp,
    hashMatcheDifficulty,
};

//const blockchain = [];

// 기존 chainedblock.js의 내용들로 구성
